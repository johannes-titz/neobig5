...
Open the .Rmd-files and run them to create all tables, figures and overviews (html). Note that knitting the Rmd-files will not rerun the simulations but use the cached simulations.

## More details

There are three .Rmd files that produce simulations, tables and figures, one additional .Rmd file produces Figure 1.
